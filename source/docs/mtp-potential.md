...
现在，superMD 已经支持了 MLIP-2 势函数（注：mlip-2 是 MTP 势的一种实现）。

## mlip-2 与 superMD 的集成
...
@@ -16,6 +16,7 @@ dependencies:
     git.hpcer.dev/HPCer/superMD/potential: {version: v0.3.0, target: pot}
     git.hpcer.dev/HPCer/superMD/libcomm: {version: v0.3.4, target: comm}
     github.com/superkmc/xoshiro: {version: v0.1.1, target: xoshiro}
